...
$root.demo = (function() {
    ...
    demo.protocol = (function() {
        ...
        protocol.Answer = (function() {
             ...
             * @interface IAnswer
             * @property {string|null} [type] Defines the type of this answer message in a string.
             * @property {google.protobuf.IAny|null} [data] The data of the answer of any data type.
             */
            ...
            /**
             * Defines the type of this answer message in a string.
             * @member {string} type
            ...
            /**
             * The data of the answer of any data type.
        ...
        protocol.Vertex = (function() {
             ...
             * @memberof demo.protocol
             * @interface IVertex
             * @property {number|Long|null} [id] Vertex id
             ...
             * @instance
             */
            Vertex.prototype.id = $util.Long ? $util.Long.fromBits(0,0,true) : 0;
        ...
        protocol.Edge = (function() {
             ...
             * @memberof demo.protocol
             * @interface IEdge
             * @property {number|Long|null} [id] Edge id
             * @property {Object.<string,string>|null} [properties] Edge properties
             * @property {Array.<string>|null} [labels] Edge labels
             * @property {number|Long|null} [fromVertex] Edge fromVertex
             * @property {number|Long|null} [toVertex] Edge toVertex
             * @property {Array.<number|Long>|null} [metaEdges] Edge metaEdges
             */
             ...
             * @instance
             */
            Edge.prototype.id = $util.Long ? $util.Long.fromBits(0,0,true) : 0;
            ...
            /**
             * Edge fromVertex.
             * @member {number|Long} fromVertex
             * @memberof demo.protocol.Edge
             * @instance
             */
            Edge.prototype.fromVertex = $util.Long ? $util.Long.fromBits(0,0,true) : 0;

            /**
             * Edge toVertex.
             * @member {number|Long} toVertex
             * @memberof demo.protocol.Edge
             * @instance
             */
            Edge.prototype.toVertex = $util.Long ? $util.Long.fromBits(0,0,true) : 0;

            /**
             * Edge metaEdges.
             * @member {Array.<number|Long>} metaEdges
             * @memberof demo.protocol.Edge
             * @instance
             */
            ...
            Edge.decode = function decode(reader, length) {
                ...
                while (reader.pos < end) {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        message.fromVertex = reader.uint64();
                        break;
                    case 5:
                        message.toVertex = reader.uint64();
                        break;
                    case 6:
                        ...
                        if ((tag & 7) === 2) {
                            var end2 = reader.uint32() + reader.pos;
                            while (reader.pos < end2)
                                message.metaEdges.push(reader.uint64());
                        } else
                            message.metaEdges.push(reader.uint64());
                        break;
                    default:
            ...
            Edge.verify = function verify(message) {
                ...
                if (message.fromVertex != null && message.hasOwnProperty("fromVertex"))
                    if (!$util.isInteger(message.fromVertex) && !(message.fromVertex && $util.isInteger(message.fromVertex.low) && $util.isInteger(message.fromVertex.high)))
                        return "fromVertex: integer|Long expected";
                if (message.toVertex != null && message.hasOwnProperty("toVertex"))
                    if (!$util.isInteger(message.toVertex) && !(message.toVertex && $util.isInteger(message.toVertex.low) && $util.isInteger(message.toVertex.high)))
                        return "toVertex: integer|Long expected";
                if (message.metaEdges != null && message.hasOwnProperty("metaEdges")) {
                    ...
                    for (var i = 0; i < message.metaEdges.length; ++i)
                        if (!$util.isInteger(message.metaEdges[i]) && !(message.metaEdges[i] && $util.isInteger(message.metaEdges[i].low) && $util.isInteger(message.metaEdges[i].high)))
                            return "metaEdges: integer|Long[] expected";
                }
                return null;
            };
            ...
            Edge.fromObject = function fromObject(object) {
                ...
                if (object.fromVertex != null)
                    if ($util.Long)
                        (message.fromVertex = $util.Long.fromValue(object.fromVertex)).unsigned = true;
                    else if (typeof object.fromVertex === "string")
                        message.fromVertex = parseInt(object.fromVertex, 10);
                    else if (typeof object.fromVertex === "number")
                        message.fromVertex = object.fromVertex;
                    else if (typeof object.fromVertex === "object")
                        message.fromVertex = new $util.LongBits(object.fromVertex.low >>> 0, object.fromVertex.high >>> 0).toNumber(true);
                if (object.toVertex != null)
                    if ($util.Long)
                        (message.toVertex = $util.Long.fromValue(object.toVertex)).unsigned = true;
                    else if (typeof object.toVertex === "string")
                        message.toVertex = parseInt(object.toVertex, 10);
                    else if (typeof object.toVertex === "number")
                        message.toVertex = object.toVertex;
                    else if (typeof object.toVertex === "object")
                        message.toVertex = new $util.LongBits(object.toVertex.low >>> 0, object.toVertex.high >>> 0).toNumber(true);
                if (object.metaEdges) {
                    ...
                    for (var i = 0; i < object.metaEdges.length; ++i)
                        if ($util.Long)
                            (message.metaEdges[i] = $util.Long.fromValue(object.metaEdges[i])).unsigned = true;
                        else if (typeof object.metaEdges[i] === "string")
                            message.metaEdges[i] = parseInt(object.metaEdges[i], 10);
                        else if (typeof object.metaEdges[i] === "number")
                            message.metaEdges[i] = object.metaEdges[i];
                        else if (typeof object.metaEdges[i] === "object")
                            message.metaEdges[i] = new $util.LongBits(object.metaEdges[i].low >>> 0, object.metaEdges[i].high >>> 0).toNumber(true);
                }
                return message;
            };
            ...
            Edge.toObject = function toObject(message, options) {
                ...
                if (options.defaults) {
                    ...
                    if ($util.Long) {
                        var long = new $util.Long(0, 0, true);
                        object.fromVertex = options.longs === String ? long.toString() : options.longs === Number ? long.toNumber() : long;
                    } else
                        object.fromVertex = options.longs === String ? "0" : 0;
                    if ($util.Long) {
                        var long = new $util.Long(0, 0, true);
                        object.toVertex = options.longs === String ? long.toString() : options.longs === Number ? long.toNumber() : long;
                    } else
                        object.toVertex = options.longs === String ? "0" : 0;
                }
                if (message.id != null && message.hasOwnProperty("id"))
                    if (typeof message.id === "number")
                        object.id = options.longs === String ? String(message.id) : message.id;
                ...
                if (message.fromVertex != null && message.hasOwnProperty("fromVertex"))
                    if (typeof message.fromVertex === "number")
                        object.fromVertex = options.longs === String ? String(message.fromVertex) : message.fromVertex;
                    else
                        object.fromVertex = options.longs === String ? $util.Long.prototype.toString.call(message.fromVertex) : options.longs === Number ? new $util.LongBits(message.fromVertex.low >>> 0, message.fromVertex.high >>> 0).toNumber(true) : message.fromVertex;
                if (message.toVertex != null && message.hasOwnProperty("toVertex"))
                    if (typeof message.toVertex === "number")
                        object.toVertex = options.longs === String ? String(message.toVertex) : message.toVertex;
                    else
                        object.toVertex = options.longs === String ? $util.Long.prototype.toString.call(message.toVertex) : options.longs === Number ? new $util.LongBits(message.toVertex.low >>> 0, message.toVertex.high >>> 0).toNumber(true) : message.toVertex;
                if (message.metaEdges && message.metaEdges.length) {
                    object.metaEdges = [];
                    for (var j = 0; j < message.metaEdges.length; ++j)
                        if (typeof message.metaEdges[j] === "number")
                            object.metaEdges[j] = options.longs === String ? String(message.metaEdges[j]) : message.metaEdges[j];
                        else
                            object.metaEdges[j] = options.longs === String ? $util.Long.prototype.toString.call(message.metaEdges[j]) : options.longs === Number ? new $util.LongBits(message.metaEdges[j].low >>> 0, message.metaEdges[j].high >>> 0).toNumber(true) : message.metaEdges[j];
                }
                return object;
            };
        ...
        protocol.Query = (function() {
             ...
             * @memberof demo.protocol
             * @interface IQuery
             * @property {string|null} [query] The query to be executed.
             * @property {string|null} [language] The query language used in field query.
             * @property {Object.<string,string>|null} [args] A map of query arguments to be considered by the executing database.
             * @property {Array.<string>|null} [filter] One or more filters for the answers.
             * 
            ...
            /**
             * The query language used in field query.
            ...
            /**
             * A map of query arguments to be considered by the executing database.
            ...
            /**
             * One or more filters for the answers.
             * 
             * If no filter is provided, all answers will be sent.
             * Otherwise only answers matching at least one filter will be sent.
